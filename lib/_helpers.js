// Función para obtener la navegacion de las sesiones de un usuario (limitando las sesiones)
export async function getSessions(firestore, collection, getDocs, orderBy, query, where, userId, actualSessionId) {
